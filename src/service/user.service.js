...
class UserService{
    async createUser(openid,session_key){
        return await User.create({openid,session_key})//创建数据库条目 更多查询器参考https://www.sequelize.com.cn/core-concepts/model-querying-basics
    }
